...
export const btnBillingPortal = byId("btnBillingPortal");
...
export const dashboardAdminOnboarding = byId("dashboardAdminOnboarding");
export const adminOnboardingProgressText = byId("adminOnboardingProgressText");
export const adminOnboardingProgressLabel = byId("adminOnboardingProgressLabel");
export const adminOnboardingProgressBar = byId("adminOnboardingProgressBar");
export const adminOnboardingList = byId("adminOnboardingList");
...
export const companyDetailTabCompany = byId("companyDetailTabCompany");
export const companyDetailTabFinancial = byId("companyDetailTabFinancial");
export const companyDetailTabUsers = byId("companyDetailTabUsers");
export const companyDetailCompanyCardInfo = byId("companyDetailCompanyCardInfo");
export const companyDetailFinancialCardInfo = byId("companyDetailFinancialCardInfo");
export const companyDetailUsersCardInfo = byId("companyDetailUsersCardInfo");
export const companyDetailCompanySummary = byId("companyDetailCompanySummary");
export const companyInfoName = byId("companyInfoName");
export const companyInfoCnpj = byId("companyInfoCnpj");
export const companyInfoId = byId("companyInfoId");
export const companyInfoStatus = byId("companyInfoStatus");
...
export const companyUsersPlanLimitCount = byId("companyUsersPlanLimitCount");
...
export const companyPlanDetail = byId("companyPlanDetail");
export const companyPlanBillingCycleDetail = byId("companyPlanBillingCycleDetail");
export const companyPlanInstallmentsDetail = byId("companyPlanInstallmentsDetail");
export const companyPlanSummary = byId("companyPlanSummary");
export const btnSaveCompanyPlan = byId("btnSaveCompanyPlan");
export const companyFinancialSummary = byId("companyFinancialSummary");
export const companyFinancialNameDetail = byId("companyFinancialNameDetail");
export const companyFinancialEmailDetail = byId("companyFinancialEmailDetail");
export const companyFinancialPhoneDetail = byId("companyFinancialPhoneDetail");
export const companyBillingStartDateDetail = byId("companyBillingStartDateDetail");
export const companyBillingEndDateDetail = byId("companyBillingEndDateDetail");
export const companyBillingDueDateDetail = byId("companyBillingDueDateDetail");
export const btnSaveCompanyFinancial = byId("btnSaveCompanyFinancial");
export const companyInstallmentsPanel = byId("companyInstallmentsPanel");
export const companyInstallmentsSummary = byId("companyInstallmentsSummary");
export const companyInstallmentsList = byId("companyInstallmentsList");
export const companyRenewalSummary = byId("companyRenewalSummary");
export const companyRenewalPlan = byId("companyRenewalPlan");
export const companyRenewalCycle = byId("companyRenewalCycle");
export const companyRenewalInstallments = byId("companyRenewalInstallments");
export const companyRenewalStartDate = byId("companyRenewalStartDate");
export const companyRenewalEndDate = byId("companyRenewalEndDate");
export const companyRenewalDueDate = byId("companyRenewalDueDate");
export const btnCreateCompanyRenewal = byId("btnCreateCompanyRenewal");
export const companyBillingHistoryList = byId("companyBillingHistoryList");
...
export const companyFinancialPhoneEl = byId("companyFinancialPhone");
export const companyBillingStartDateEl = byId("companyBillingStartDate");
export const companyBillingDueDateEl = byId("companyBillingDueDate");
...
export const btnOpenManualActivity = byId("btnOpenManualActivity");
...
export const modalManualActivity = byId("modalManualActivity");
export const btnCloseManualActivityModal = byId("btnCloseManualActivityModal");
export const btnCancelManualActivityModal = byId("btnCancelManualActivityModal");
export const btnSaveManualActivity = byId("btnSaveManualActivity");
export const manualActivityAlert = byId("manualActivityAlert");
export const manualActivityProject = byId("manualActivityProject");
export const manualActivityTask = byId("manualActivityTask");
export const manualActivityName = byId("manualActivityName");
export const manualActivityDate = byId("manualActivityDate");
export const manualActivityHours = byId("manualActivityHours");
export const manualActivityKeyUsers = byId("manualActivityKeyUsers");
export const manualActivitySelectedKeyUsers = byId("manualActivitySelectedKeyUsers");
export const manualActivityKeyUsersChips = byId("manualActivityKeyUsersChips");
export const manualActivityNote = byId("manualActivityNote");
export const manualActivityNoteCounter = byId("manualActivityNoteCounter");
export const manualActivityAvailabilityHint = byId("manualActivityAvailabilityHint");
...
export const expenseApprovalsApprovedValue = byId("expenseApprovalsApprovedValue");
export const expenseApprovalsRejectedValue = byId("expenseApprovalsRejectedValue");
